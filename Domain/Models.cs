...
public sealed record Occurrence(Guid Id, Guid CompanyId, Guid InspectionId, string Title, string Priority, string Status, DateTime DueDate, decimal EstimatedCost, string PropertyName, string? Room = null);
